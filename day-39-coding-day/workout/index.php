...
// $generic_dog = new Dog("Woofie");
// var_dump($generic_dog);
// die();
...
class Chihuahua extends Dog
{
    public function __construct($name, $natural_enemies = [])
    {
        $this->position = "standing";
        $this->name = $name;
        $this->natural_enemies = array_merge(["literally everything"], $natural_enemies);
    }
...
<?php $second_dog = new Chihuahua("Fury"); ?>

<p>Chihuahua's name is <?= $second_dog->readDogTag() ?></p>
<p>Chihuahua goes <?= $second_dog->barkAt('tree') ?></p>
